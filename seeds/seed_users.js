  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {id: 4, first_name: 'Max', last_name: 'Daisy', user_name: 'JohnSmith', email: 'JMDaisy@email.com', password: 'JSmith123', medical_issue: 'Anxiety', account_type: 'specialist'},
        {id: 5, first_name: 'Bob', last_name: 'Sullivan', user_name: 'JaneDoe', email: 'BSully@email.com', password: 'JDoe123', medical_issue: 'Depression', account_type: 'specialist'}
      ]);
    });
};